...
_, tempfilename = tempfile.mkstemp(prefix=timestamp + ".saci.", suffix=".log")
...
default_config = {
    ...
    "formatters": {
        "console": {"format": string_format},
        "logfile": {"format": string_format},
    },
    "handlers": {
        "console": {
    ...
    "loggers": {
        "saci": {"handlers": ["console", "local_file_handler"], "level": "INFO", "propagate": False},
    },
}

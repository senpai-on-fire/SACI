...
class ExpressLRSBackpack(CyberComponentBase):
    ...
    def __init__(self, protocol="CRSF", mode="RECEIVER_TO_FC", **kwargs):
        ...
        :param mode: Direction or mode of communication (e.g., "RECEIVER_TO_FC", "FC_TO_ACCESSORY").
        """
...
class ExpressLRSBackpackHigh(CyberComponentHigh):
    ...
    def __init__(self, protocol="CRSF", mode="RECEIVER_TO_FC", connected_device=None, data_rate="Low", **kwargs):
        """
        :param protocol: Protocol used for communication (e.g., CRSF).
        :param mode: Communication direction.
        :param connected_device: Device connected to the backpack (e.g., flight controller).
        :param data_rate: Relative throughput of the Backpack link ("Low", "Medium", "High").
        """
        super().__init__(**kwargs)
        self.protocol = protocol
        self.mode = mode
...
class ExpressLRSBackpackAlgorithmic(CyberComponentAlgorithmic):
    ...
    def __init__(self, protocol="CRSF", mode="RECEIVER_TO_FC", connected_device=None, data_buffer=None, **kwargs):
        """
        :param protocol: Protocol used for communication (e.g., CRSF).
    ...
    def receive_data(self, message):
        """
        Receives a message via Backpack.
    ...
    def attach_device(self, device_name):
        ...
        :param device_name: Identifier of the device (e.g., 'ArduPilotController')
        """
